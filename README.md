...
2.  OR type `wal -i <path to image` and Pywal genetes theme
3.  Once you populate _~/Pictures/wallpaper/_ you can choose wallpaper from swayimg and it auto generates colors
