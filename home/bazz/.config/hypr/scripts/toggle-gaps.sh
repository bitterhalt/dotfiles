...
if [ "$gaps_in_current" = "null" ] && [ "$gaps_out_current" = "null" ] && [ "$rounding_current" = "null" ] && [ "$border_size_current" = "null" ]; then
  hyprctl keyword workspace "$rid" f[1], gapsin:0, gapsout:0, rounding:0, bordersize:0
  hyprctl keyword workspace "$rid" w[tv1], gapsin:0, gapsout:0, rounding:0, bordersize:0
